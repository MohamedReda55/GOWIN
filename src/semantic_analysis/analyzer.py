...
from ..lexical_analysis import token_type
...
class SemanticAnalyzer(NodeVisitor):
    ...
    class CType(object):
        types = dict(char=int, int=int, float=float, double=float,list=list,str=str)
        order = ('char', 'int', 'float', 'double','list','str')
    ...
    def visit_List(self,node):
        return SemanticAnalyzer.CType("list")
