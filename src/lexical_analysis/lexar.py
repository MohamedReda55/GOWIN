...
RESERVED_KEYWORDS = {
    ...
    'فعل': Token(DO, 'do'),
    'رجوع': Token(RETURN, 'return'),
    'كسر': Token(BREAK, 'break'),
    'استمرار': Token(CONTINUE, 'continue'),
    'فارغ': Token(VOID, 'void'),   
    'تبديل': Token(SWITCH, 'switch'),
    'حالة': Token(CASE, 'case'),
    'افتراضي': Token(DEFAULT, 'default')
